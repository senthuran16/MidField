...
function mcImgSlider(i) {
	...
	L.prototype = {
		k: {
			...
			if (a) {
				...
				if (J && V)V(this.b); else window.clearInterval(this.b);
				this.b = null
			}
		}, o: function (a) {
			if (a.d.e < a.d[d]) {
	...
	var G = new L, fb = function () {
		...
		if (f)a.m = Math.ceil(f.offsetHeight * a.g / f[bb]);
		hb(i.effect);
		a.n = function () {
			var b;
	...
	kb.prototype = {
		c: function () {
			...
			if (a[k] != "IMG") {
				if (a[k] == "A")var d = a[h]("href"), f = a[h]("title") || "", i = 1; else if (a[k] == "VIDEO" || a[k] == "AUDIO") {
					var n = 1;
					d = a[h]("data-image");
					if (d)f = a[h]("data-alt") || "";
	...
	var Y = function () {
		var a = I(i.sliderId);
		if (a && t(a)[d] && a.offsetHeight)j = new kb(a); else u(Y, 500)
	};
	X();
	var Ab = function (c) {
		var a = false;
	...
	var Db = function () {
		...
		if (++lb < 20)if (!j || typeof tooltip == p)u(function () {
			eb(e, c)
