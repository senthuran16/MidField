...
<div class="contentDiv">
	...
	<a class="productsSubMenu" href="ShoppingCartShoes.php">Shoes </a> <a>| </a> <a class="productsSubMenu" href="ShoppingCartClothing.php"><font class="fontRed" >Clothing </font></a> <a>| </a><a class="productsSubMenu" href="ShoppingCartAccessories.php">Accessories</a>
		...
		echo"<div id=product1Summary class=shoppingCartProductSummaryPopup>";
			...
			echo"<div class=productSummaryDiv>";
				...
				echo"<div class=shoppingCartSummaryDetails>";
					...
					echo"<form name=formPC001 method=post action=addToCartClothingAction.php>";
							...
							$productQty = $productRow['availableQty'];
  							...
  							if(isset($_SESSION["session1"])){
								...
								echo"<input type=text name=pc001Qty size=2 required>";
		...
		echo"<div id=product2Summary class=shoppingCartProductSummaryPopup>";
			...
			echo"<div class=productSummaryDiv>";
				...
				echo"<div class=shoppingCartSummaryDetails>";
					...
					echo"<form name=formPC002 method=post action=addToCartClothingAction.php>";
							...
							$productQty = $productRow['availableQty'];
  							...
  							if(isset($_SESSION["session1"])){
  								...
  								// Getting the available quantity from the database
								echo"<a><b>Quantity&nbsp;</b></a>";
								echo"<input type=text name=pc002Qty size=2 required>";
								echo"<a><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stock : ".$productQty."</b></a>";
								echo"<br/><br/>";
		...
		echo"<div id=product3Summary class=shoppingCartProductSummaryPopup>";
			...
			echo"<div class=productSummaryDiv>";
				...
				echo"<div class=shoppingCartSummaryDetails>";
					...
					echo"<form name=formPC003 method=post action=addToCartClothingAction.php>";
							...
							$productQty = $productRow['availableQty'];
  							...
  							if(isset($_SESSION["session1"])){
  								...
  								// Getting the available quantity from the database
								echo"<a><b>Quantity&nbsp;</b></a>";
								echo"<input type=text name=pc003Qty size=2 required>";
								echo"<a><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stock : ".$productQty."</b></a>";
								echo"<br/><br/>";
		...
		echo"<div id=product4Summary class=shoppingCartProductSummaryPopup>";
			...
			echo"<div class=productSummaryDiv>";
				...
				echo"<div class=shoppingCartSummaryDetails>";
					...
					echo"<form name=formPC004 method=post action=addToCartClothingAction.php>";
							...
							$productQty = $productRow['availableQty'];
  							...
  							if(isset($_SESSION["session1"])){
  								...
  								// Getting the available quantity from the database
								echo"<a><b>Quantity&nbsp;</b></a>";
								echo"<input type=text name=pc004Qty size=2 required>";
								echo"<a><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stock : ".$productQty."</b></a>";
								echo"<br/><br/>";
